<?php
    ...
    $cdn = get_cdn().'/laravel-log-viewer';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link rel="stylesheet"
        href="{{$cdn}}/bootstrap/4.0.0/css/bootstrap.min.css"
        integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm"
        crossorigin="anonymous">
  <link rel="stylesheet" type="text/css" href="{{$cdn}}/1.10.16/css/dataTables.bootstrap4.min.css">
  <style>
    body {
      padding: 25px;
    }
...
<script src="{{$cdn}}/1.10.16/js/jquery-3.2.1.slim.min.js"
        integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN"
        crossorigin="anonymous"></script>
<script src="{{$cdn}}/bootstrap/4.0.0/js/bootstrap.min.js"
        integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl"
        crossorigin="anonymous"></script>
<!-- FontAwesome -->
<script defer src="{{$cdn}}/releases/v5.0.6/js/all.js"></script>
<!-- Datatables -->
<script type="text/javascript" src="{{$cdn}}/1.10.16/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="{{$cdn}}/1.10.16/js/dataTables.bootstrap4.min.js"></script>
